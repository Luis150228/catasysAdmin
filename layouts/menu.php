                ...
                <li class=" nav-item"><a href="#"><i class="mbri-edit"></i><span class="menu-title" data-i18n="Forms">Valores</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#"><i class="mbri-edit"></i><span data-i18n="Users">Variables Anuales</span></a>
                            <ul class="menu-content">
                                <li><a class="menu-item" href="./traslados/valores.php"><i class="material-icons"></i><span data-i18n="Users List">Valores</span></a>
                                </li>
                                <li><a class="menu-item" href="./traslados/multasRecargos.php"><i class="material-icons"></i><span data-i18n="Users Edit">Multas y recargos</span></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
