                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input data-toggle="tooltip" data-placement="top" title="Tipo de Movimiento" name="tipopVw" id="tipopVw" class="form-control border-primary" value="<?php if ( $data_form['tipop'] = 'U') {echo 'Urbano';} else {echo 'Rustico';}?>">
                                                                </input>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="userinput2">Tipo Movimiento</label>
                                                                <input data-toggle="tooltip" data-placement="top" title="Tipo de Movimiento" type="text" name="movimiento" id="movimiento" class="form-control border-primary" placeholder="Movimiento" value="<?php echo $data_form['tipomov']?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input data-toggle="tooltip" data-placement="top" title="Notario" type="text" name="notarios" id="notarios" class="form-control border-primary" placeholder="Notario" value="<?php echo utf8_encode($data_form['notario'])?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <div class="col-md-9 mx-auto">
                                                                <h4 id="totalH4">Documentacion</h4>
